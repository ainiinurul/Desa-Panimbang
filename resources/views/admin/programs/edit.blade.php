        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Edit Program Desa</h1>
                        <p class="text-sm text-gray-500 mt-1">Perbarui informasi program desa</p>
                    </div>
                </div>
                <div class="hidden sm:flex items-center space-x-2">
                    <div class="flex items-center space-x-2 text-sm text-gray-500">
                        <i class="fas fa-clock"></i>
                        <span>Terakhir diubah: {{ $program->updated_at->format('d/m/Y H:i') }}</span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="status" id="status" 
                                    ...
                                    <option value="published" {{ old('status', $program->status) == 'published' ? 'selected' : '' }}>
                                        ✅ Published
                                    </option>
                                    <option value="scheduled" {{ old('status', $program->status) == 'scheduled' ? 'selected' : '' }}>
                                        ⏰ Scheduled
                                    </option>
                                </select>
                            </div>
