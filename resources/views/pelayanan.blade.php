            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-blue-50 rounded-lg p-6 shadow transform transition-all duration-500 hover:-translate-y-2 hover:shadow-lg">
                    ...
                    <ul class="space-y-2 text-gray-700">
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Semua fotokopi harus disertai dengan dokumen asli untuk diverifikasi.</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Pas foto menggunakan background sesuai ketentuan (biasanya merah atau biru).</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Meterai 10.000 (sesuai tarif terbaru)</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Surat pengantar RT/RW wajib untuk semua jenis surat.</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Formulir permohonan diisi lengkap dan jelas.</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Waktu penyelesaian umumnya 1-3 hari kerja.</li>
                    </ul>
                </div>
                ...
                <div class="bg-blue-50 rounded-lg p-6 shadow transform transition-all duration-500 hover:-translate-y-2 hover:shadow-lg">
                    ...
                    <ul class="space-y-2 text-gray-700">
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Senin - Jumat: 08.00 - 16.00 WIB</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Sabtu - Minggu: Tutup</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Pengambilan dokumen: Maksimal 5 hari kerja</li>
                    </ul>
                </div>
                ...
                <div class="bg-blue-50 rounded-lg p-6 shadow transform transition-all duration-500 hover:-translate-y-2 hover:shadow-lg">
                    ...
                    <ul class="space-y-2 text-gray-700">
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Seluruh pelayanan bersifat gratis</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Datang pada jam operasional yang tepat.</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Status permohonan dapat dicek melalui WhatsApp</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Pengambilan dokumen harus membawa KTP asli</li>
                        <li class="flex items-start"><svg class="h-5 w-5 mr-2 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>Tanyakan kepada petugas jika ada persyaratan tambahan.</li>
                    </ul>
                </div>
            </div>
        </div>
